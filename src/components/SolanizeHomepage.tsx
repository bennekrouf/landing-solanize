  ...
  return (
    <LayoutTemplate>
      ...
      <section className="relative py-20 md:py-32 bg-gradient-to-br from-background via-background to-muted/20">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#8b5cf6,#ec4899,#f59e0b)] opacity-[0.02] bg-[size:40px_40px] bg-[position:0_0,20px_20px] bg-repeat"></div>
        ...
        <div className="container relative">
          ...
          >
            <motion.div variants={fadeInUp} className="mb-6">
              <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 text-purple-600 dark:text-purple-400">
...
>              </button>
      ...
      {/* Final CTA */}
      <section className="py-20 bg-gradient-to-br from-purple-500/10 via-pink-500/10 to-orange-500/10">
        <div className="container">
          <motion.div 
